...
#[no_mangle]
pub extern "C" fn get_pixel_data(input: *mut moo3d_core::GameState) -> *mut wasm_interopt::Uint8Array {
    unsafe {
        wasm_interopt::Uint8Array::new((*input).get_mut_pixels())
    }
}
...
#[no_mangle]
pub unsafe extern "C" fn translate_camera(input: &mut moo3d_core::GameState, trans_x: isize, trans_y: isize, trans_z: isize) {
